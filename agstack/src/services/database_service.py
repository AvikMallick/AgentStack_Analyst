...
class DatabaseService:
    ...
    def check_schema_exists(self, host: str, port: int, username: str, password: str, database_name: str,
    ...
    def get_tables_for_schema(self, host: str, port: int, username: str, password: str, database_name: str,
    ...
    def get_schemas_and_tables(self, host: str, port: int, username: str, password: str, database_name: str) -> Dict[
        str, List[str]]:
        """
    ...
    def get_column_details(self, host: str, port: int, username: str, password: str, database_name: str,
        ...
        try:
            ...
            for row in cursor.fetchall():
                ...
                sample_values = self.get_sample_values(host, port, username, password, database_name, schema_name,
